...
SOFTWARE= {
	"QC": ["trimmomatic"], # "nanofilt", trimmomatic
	"HD": ["fve", "centrifuge", "kaiju", "kuniq", "kraken2"],
	"ASSEMBLY_SOFT": ["spades"], #spades, velvet,
	"ASSEMBLE_CLASS": ["blast", "minimap-asm", "diamond"],
	"CLASSM": ["fve" , "diamond", "centrifuge", "kaiju", "kuniq", "kraken2"],
	"REMAP_SOFT": ["snippy", "minimap-rem"] #snippy, rematch, bowtie, minimap-rem
}
...
ARGS_HD= {
	...
	"fve": {
		"FVE_ARGS": ["-cr 0.3 -co .1 -cn 5"],
		"FVE_DB": ["ncbi", "virossaurus"]
	}
}
